...
// cpl_loader.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcplloaderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CcplloaderApp

CcplloaderApp::CcplloaderApp()
{
...
// Единственный объект CcplloaderApp

CcplloaderApp theApp;


// Инициализация CcplloaderApp

BOOL CcplloaderApp::InitInstance()
{
